                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="product-quantity">
                                                                    ...
                                                                    <a href="index.php?act=cart&what=down&id=<?= $product['IdDT']?>"><div class="dec qtybutton">-</div></a>
                                                                       ...
                                                                       <a href="<?php if($product['Amount'] >=$product['SoLuongTonKho']){echo"index.php?act=cartView";} else{echo"index.php?act=cart&what=add&id=".$product['IdDT']."";} ?>"><div class="inc qtybutton">+</div></a>
                                                                    </div>
                                                                </td>
                                                        ...
                                                        <?php if(isset($_SESSION['giohang'])){ ?>
                                                            <table>
                                                                <tr>
                                                                    ...
                                                                    <td class="td-title-2"><?= $this->model->formatMoney($tong)?>VNĐ</td>
                                                                </tr>
                                                                <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="order-total-price"><?= $this->model->formatMoney($tong + 40000)?>VNĐ</td>
                                                                </tr>
                                                            </table>
                                                        <?php }else{ ?>
                                                            <table>
                                                                ...
                                                                <tr>
                                                                    <td class="order-total">Thành tiền</td>
                                                                    <td class="order-total-price">0 VNĐ</td>
                                                                </tr>
                                                            </table>
                                                        <?php } ?>
                                                    </div>
                                ...
                                <div class="tab-pane" id="order-complete">
                                    <div class="order-complete-content box-shadow">
                                        <div class="thank-you p-30 text-center">
                                            <h6 class="text-black-5 mb-0">Cảm ơn. Bạn đã đặt hàng thành công.</h6>
                                        </div>
