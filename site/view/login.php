                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="registered-customers">
                                ...
                                <form action="index.php?act=xulydangnhap" method="post">
                                    <div class="login-account p-30 box-shadow">
                                        <p>Nếu bạn đã có tài khoản bạn có thể đăng nhập</p>
                                        <p><?php if(isset($warn)){echo $warn;}?></p>
                                        <input type="text" name="name" placeholder="Tên tài khoản">
                                        <input type="password" name="password" placeholder="Mật khẩu">
                                        <p><small><a href="doi-mat-khau">Đổi mật khẩu</a></small><small> | <a href="quen-mat-khau">Quên mật khẩu?</a></small></p>
                                        <button class="submit-btn-1 btn-hover-1" type="submit" name="submit" value="submit">đăng nhập</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <form action="#">
                                    ...
                                    <div class="login-account p-30 box-shadow">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <button class="submit-btn-1 mt-20 btn-hover-1 f-right" type="reset">Xóa</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
